...
import static kr.ac.inha.stress_sensor.services.CustomSensorsService.DATA_SRC_APP_USAGE;
        ...
        if (Tools.isMainServiceRunning(con)) {
            ...
            for (int i = 0; i < statCount; i++) {
                ...
                try {
                    ...
                    if (duration > 0) {
                        String value = pkgStats.getFirstTimeStamp() + "||" + pkg_name + "||" + app_name + "||" + duration + "||" + Tools.getEMAOrderFromRangeBeforeEMA(pkgStats.getFirstTimeStamp());
