...
import static kr.ac.inha.stress_sensor.services.CustomSensorsService.DATA_SRC_GPS_LOCATIONS;
...
public class LocationService extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        */
        ...
        try {
            String value = location.getTime() + " " + location.getLatitude() + " " + location.getLongitude() + " " + location.getAccuracy() + " " + location.getAltitude() + " " + Tools.getEMAOrderFromRangeBeforeEMA(location.getTime());
