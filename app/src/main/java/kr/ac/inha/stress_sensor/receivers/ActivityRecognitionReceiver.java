...
import static kr.ac.inha.stress_sensor.services.CustomSensorsService.DATA_SRC_ACTIVITY;
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (ActivityRecognitionResult.hasResult(intent)) {
                ...
                db.insertSensorData(DATA_SRC_ACTIVITY, result.getTime() + " " + activity + " " + confidence + " " + Tools.getEMAOrderFromRangeBeforeEMA(result.getTime()));
